...
COPY --from=compile /usr/project/target/release/pgmer2-pg16/usr/share/postgresql16/extension/pgmer2--0.2.2.sql /usr/local/share/postgresql/extension/pgmer2--0.2.2.sql
